...
export default function Banner() {
    ...
    return (
        <>
            {isHomePage && (
                <div className={`w-full ${closeBanner ? 'flex' : 'hidden animate-fade-down animate-once animate-duration-[5000ms] animate-reverse'} justify-center items-center bg-[#F77429] relative py-3`}>
